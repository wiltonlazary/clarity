...
export const APP_ROUTES: Routes  = [
    ...
    { path: "gauge", loadChildren: "clarity-demos/gauge/demo/gauge.demo.module" },
    { path: "horseshoe-gauge", loadChildren: "clarity-demos/gauge-horseshoe/demo/gauge-horseshoe.demo.module" },
    { path: "bar-gauge", loadChildren: "clarity-demos/gauge-bar/demo/gauge-bar.demo.module" },
